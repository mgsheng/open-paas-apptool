package cn.com.open.apptoolservice.app.interceptor;

import cn.com.open.apptoolservice.app.common.ExceptionEnum;
import cn.com.open.apptoolservice.app.common.PlatformEnum;
...
import cn.com.open.apptoolservice.app.utils.ParamUtil;
...
public class VerifySignatureInterceptor implements HandlerInterceptor {
    ...
    @Value("${apptool.verifySignature.onOff}")
